...
//  if (!value) return '';
  ...
  var p = helper.partials[key1] || helper.partials[key2] || helper.partials[key3] || helper.partials[key4];
  return p({field: field, value: value, context: {module:moduleNamespace, view:view}});
};
...
labeler.get = function(name, context) {
