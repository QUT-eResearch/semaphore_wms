...
ExModule.prototype.install = function(options) {
  ...
  try {
    ...
    for (var key in models) if ('function' === typeof models[key].install) models[key].install(options);
...
ExModule.prototype.uninstall = function(options) {
  ...
  try {
    ...
    var models = this.models;
    for (var key in models) if ('function' === typeof models[key].uninstall) models[key].uninstall(options);
    this._state &= ~FLAG_INSTALLED;
    stateModified = true;
