...
var extractField = exports.extractField = function(schemaField) {
  ...
  if (!schemaType) {
    ...
    if (schemaField.schema) {
      ...
      //TODO: must handle nested schema
      if (typeof schemaType[0] === 'object') {
        if (schemaType[0].type) field.of = schemaType[0].type.name
